...
/*▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    ...
    ▬ "HashMap" Class
        ...
        → which "Allows" us to "Store Key" and "Value" Pair,
        → where "Keys" should be "Unique".
        → If we try to "Insert" the "Duplicate Key",
        → it will "Replace" the "Element"
    ...
    ▬ "HashMap" Class
        → is like the legacy "Hashtable" Class,
        → but it is "Not Synchronized". It allows us to store the null elements as well, but there should be only one null key. Since Java 5,
...
public class HashMap_Class {
    ...
    public static void main(String[] args) {
        ...
        // ▼ Creating a "Map" Collection Object of "HashMap" Type ▼
        Map<String,Integer> phoneNumbers = new HashMap<>();


        // ▼ Adding "Data" to the "Map" Collection ▼
        phoneNumbers.put("Marius", 987654);
        phoneNumbers.put("Jeanine", 123456);
