...
public class StudentNonAccessModifiersForAttributes {
    ...
    //      > Select "Constructor"
    //      > Select "oop.Student"
    public StudentNonAccessModifiersForAttributes() {
        // ▼ "STATIC" VARIABLE ▼
        // ▼ Increase "ID" by "1"
    ...
    //      > Select "Constructor"
    //      > Select "All Fields"
    public StudentNonAccessModifiersForAttributes(String name, int age, String color, char gender) {
        this.name = name;
        this.age = age;
        this.color = color;
        this.gender = gender;
    ...
    public void finalMethod(){
        // ▼ Re-Assignment
        //    → "Error": Cannot assign a value to final variable 'finalVariable' ▼
//        finalVariable = 20;
    }
    ...
    //___________________________________________________________
//    abstract int abstractVariable2 = 10;
