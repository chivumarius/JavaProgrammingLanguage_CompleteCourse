...
// ▬ The "Interface"
//      → that Allows "Avoidance" of "Redundant Code"▬
public interface Shape {

    // ▬○▬ "Code Sharing"
    //          → is "Note Useful" in "This Case"
    //          → because "Each Class"
    //          → "Implements" its "Behavior Differently" ▬○▬


    // ▬ "Calculate Area()" Method Header ▬
    double calculateArea();



    // ▬ "Calculate Perimeter()" Method Header ▬
